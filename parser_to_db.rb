...
def addtocsv url, price, date
	...
	#@db.execute "INSERT INTO Prices (URL, Price, Date_price, Date_check) VALUES ('url', '433434', 'dfdfdfdfdfdf', 'fdfdfdfdf')"
	#@db.execute "INSERT INTO Prices (URL, Price, Date_price, Date_check) VALUES (':url', ':price', 'dfdfdfdfdfdf', 'fdfdfdfdf')"
	@db.execute( "INSERT INTO Prices (URL, Price, Date_price, Date_check) VALUES ( ?, ?, ?, ? )", [url, price, dateconvert(date).strftime("%d.%m.%y"), DateTime.now.strftime("%d.%m.%y")])
